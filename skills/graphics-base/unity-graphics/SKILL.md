...
所有 Graphics Base Skill 先遵循 [`../../../knowledge/graphics/graphics-skill-routing-protocol.md`](../../../knowledge/graphics/graphics-skill-routing-protocol.md)。涉及 URP 时，再遵循 [`../../../knowledge/graphics/urp-detection-version-routing.md`](../../../knowledge/graphics/urp-detection-version-routing.md)，不要在各 Skill 中重复维护版本检测规则。
...
对于 URP，额外记录统一检测协议要求的 Unity/URP 版本、Renderer、Pass 路径、资源模式、目标平台、证据和置信度。没有这些证据时，不生成绑定特定版本的完整代码。
...
路由、事实卡、Confirmed/Inferred/Blocked/Validated 的统一交付格式见 [`../../../knowledge/graphics/graphics-skill-routing-protocol.md`](../../../knowledge/graphics/graphics-skill-routing-protocol.md)。
